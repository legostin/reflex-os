...
- Overlay helpers: reflexInvoke, reflexSystemContext, reflexSystemOpenUrl/OpenPath/RevealPath, reflexLog, reflexManifestGet/Update, reflexCapabilities, reflexAgentAsk/StartTopic/Task/Stream/StreamAbort, reflexStorageGet/Set/List/Delete, reflexFsRead/List/Write/Delete, reflexClipboardReadText/WriteText, reflexNetFetch, reflexDialogOpenDirectory/OpenFile/SaveFile, reflexNotifyShow, reflexProjectsList/Open, reflexTopicsList/Open, reflexSkillsList, reflexMcpServers, reflexBrowser*, reflexMemory*, reflexScheduler*, reflexAppsList, reflexAppsOpen, reflexAppsInvoke, reflexAppsListActions, reflexEventOn/Off/Emit.\n\
...
fn build_app_creation_prompt(description: &str, template: &str) -> String {
    ...
    p.push_str("  logs.write({level?, source?, message}) -> {ok}     — записать диагностическое событие app в Settings → Logs. level: trace|debug|info|warn|error\n");
    ...
    p.push_str("  window.reflexLog(levelOrParams, message?)\n");
