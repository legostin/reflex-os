...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    "dashboard.addPlaceholder":
      "Describe what this widget should show, for example: latest race status, available sessions, auth state...",
  ...
  ru: {
    ...
    "dashboard.addPlaceholder":
      "Опиши, что должен показывать виджет, например: статус последней гонки, доступные сессии, состояние авторизации...",
