...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    "folders.newSubfolder": "+ Subfolder",
    "folders.rename": "Rename",
    "folders.delete": "Delete",
    "folders.empty": "Empty folder.",
    "folders.namePrompt": "Folder name",
    "folders.parentPathPrompt": "Parent folder path",
    "folders.renamePrompt": "New folder name",
    "folders.deleteConfirm": "Delete this empty folder?",
    "folders.moveProjectConfirm":
      "Move the project folder on disk into the selected folder?",
    ...
    "dashboard.previewMaxItems": "Items",
    "dashboard.maxItems": "{count} max",
    "dashboard.previewFilters": "Filters",
    "dashboard.previewNoFilters": "none",
    "dashboard.previewExcluded": "Hidden fields",
    "dashboard.previewNoExcluded": "none",
    "dashboard.hiddenCount": "{count} hidden",
    ...
    "dashboard.pinnedSource": "Pinned source",
    "dashboard.moveWidgetUp": "Move widget up",
    "dashboard.moveWidgetDown": "Move widget down",
    "dashboard.cycleWidgetSize": "Size: {size}. Click to cycle.",
    "dashboard.cycleWidgetLayout": "Layout: {layout}. Click to cycle.",
    "dashboard.cycleWidgetSort": "Sort: {sort}. Click to cycle.",
  ...
  ru: {
    ...
    "folders.root": "Без папки",
    "folders.newFolder": "+ Новая папка",
    "folders.newSubfolder": "+ Подпапка",
    "folders.rename": "Переименовать",
    "folders.delete": "Удалить",
    "folders.empty": "Папка пустая.",
    "folders.namePrompt": "Название папки",
    "folders.parentPathPrompt": "Путь родительской папки",
    "folders.renamePrompt": "Новое название папки",
    "folders.deleteConfirm": "Удалить эту пустую папку?",
    "folders.moveProjectConfirm":
      "Переместить папку проекта на диске в выбранную папку?",
    ...
    "dashboard.previewMaxItems": "Элементы",
    "dashboard.maxItems": "до {count}",
    "dashboard.previewFilters": "Фильтры",
    "dashboard.previewNoFilters": "нет",
    "dashboard.previewExcluded": "Скрытые поля",
    "dashboard.previewNoExcluded": "нет",
    "dashboard.hiddenCount": "{count} скрыто",
    ...
    "dashboard.pinnedSource": "Источник",
    "dashboard.moveWidgetUp": "Переместить виджет выше",
    "dashboard.moveWidgetDown": "Переместить виджет ниже",
    "dashboard.cycleWidgetSize": "Размер: {size}. Нажми, чтобы переключить.",
    "dashboard.cycleWidgetLayout": "Вид: {layout}. Нажми, чтобы переключить.",
    "dashboard.cycleWidgetSort": "Сортировка: {sort}. Нажми, чтобы переключить.",
