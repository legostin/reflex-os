...
- Не используй dialog.*, clipboard.*, system.openUrl/openPath/revealPath, apps.create/import/commit/commitPartial/delete/restore/revert/purge, apps.open, projects.open, topics.open и scheduler.runNow/setPaused/upsert/delete внутри schedule.steps.\n\
...
fn build_app_creation_prompt(
    ...
    p.push_str("- В steps НЕЛЬЗЯ использовать dialog.openDirectory/openFile/saveFile, clipboard.readText/writeText, system.openUrl/openPath/revealPath, apps.create/import/commit/commitPartial/delete/restore/revert/purge, apps.open, projects.open и topics.open — у автоматизаций нет UI.\n");
